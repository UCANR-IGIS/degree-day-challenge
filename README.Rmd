...
*Name*: [Degree Day Validation Challenge using degday R package]()

*Submitted by*: Andy Lyons  

*Status*: The degday R package only has functions for the horizontal cutoff methods. Single-sine and single-triangle methods match the reference answers; the double methods do not. Still investigating.
